helpMain = """
 Name                       Action
 ----                       ------<
 Recherche personne (en beta)                    Faire des recherches sur une personne.
 Special p4r4dox                Utiliser des outils autre que pour de la reconnaissance.
 Fichier dox                 Creer un fichier '.txt' pour y ecrire les infos obtenu.
 Voir ma base              Accedez a la base de donnee.

...
try:
	while True:
		...
		if choix.lower() == 'h':
			...
			while True:
				...
				choix = input("\n P4R4DOX("+Fore.BLUE + "Profiler" + Fore.RESET + ")$ ")
			...
			print(lookupOption)
			while True:
				lookup = input("\n P4R4DOX("+Fore.BLUE+"Lookup"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if lookup == 'h':
					print(helpLookup)
				elif lookup.lower() == '1':
			...
			while True:
				se = input("\n P4R4DOX("+Fore.BLUE+"OtherTool"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if se == 'h':
					print(helpOtherTool)
				elif se == "1":
					hashdecrypt()
			...
			while True:
				newCode = input("\n P4R4DOX("+Fore.BLUE+"Country"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if newCode == '1':
	...
	sys.exit("\n"+information+" Coeur sur ma couille ! :)")
